...
class ResumenServicioActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        findViewById<TextView>(R.id.tvResumenTrabajo).text = mantenimiento.descripcion
        findViewById<TextView>(R.id.tvResumenDiag).text = mantenimiento.diagnostico?.ifEmpty { "N/A" } ?: "N/A"
        findViewById<TextView>(R.id.tvResumenRecom).text = mantenimiento.recomendaciones?.ifEmpty { "N/A" } ?: "N/A"
